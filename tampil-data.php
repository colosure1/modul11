...
?>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="page-header">
        <h4>
          <i class="glyphicon glyphicon-user"></i> Data tamu
  ...
  if (empty($_GET['alert'])) {
    ...
    echo "<div class='alert alert-success alert-dismissible' role='alert'>
            ...
            <strong><i class='glyphicon glyphicon-ok-circle'></i> Sukses!</strong> Data tamu berhasil disimpan.
          </div>";
  } elseif ($_GET['alert'] == 3) {
    echo "<div class='alert alert-success alert-dismissible' role='alert'>
            <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
            ...
            <strong><i class='glyphicon glyphicon-ok-circle'></i> Sukses!</strong> Data tamu berhasil diubah.
          </div>";
  } elseif ($_GET['alert'] == 4) {
    echo "<div class='alert alert-success alert-dismissible' role='alert'>
            <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
            ...
            <strong><i class='glyphicon glyphicon-ok-circle'></i> Sukses!</strong> Data tamu berhasil dihapus.
          </div>";
  }
  ?>
        ...
        <div class="panel-body">
          <div class="table-responsive">
            <table class="table table-striped table-hover">
              ...
              if (isset($cari)) {
                $jumlah_record = mysql_query("SELECT COUNT(*) FROM tamu 
              ...
              ?>
                          <a data-toggle="tooltip" data-placement="top" title="Hapus" class="btn btn-danger btn-sm" href="proses-hapus.php?id=<?php echo $data['id'];?>" onclick="return confirm('Anda yakin ingin menghapus tamu <?php echo $data['nama']; ?>?');">
